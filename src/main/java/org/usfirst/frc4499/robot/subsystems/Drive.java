...
import org.usfirst.frc4499.utility.control.AdaptivePurePursuitController;
import org.usfirst.frc4499.utility.BHRMathUtils;
import org.usfirst.frc4499.utility.TalonSRXEncoder;
import org.usfirst.frc4499.utility.ControlLoopable;
import org.usfirst.frc4499.utility.control.Kinematics;
import org.usfirst.frc4499.utility.MMTalonPIDController;
import org.usfirst.frc4499.utility.MPSoftwarePIDController;
...
import org.usfirst.frc4499.utility.MPTalonPIDPathController;
import org.usfirst.frc4499.utility.MPTalonPIDPathVelocityController;
//import org.usfirst.frc4499.utility.SoftwarePIDPositionController;
import org.usfirst.frc4499.utility.MotionProfilePoint;
//import org.usfirst.frc4499.utility.MotionProfileBoxCar;
import org.usfirst.frc4499.utility.PIDParams;
import org.usfirst.frc4499.utility.control.Path;
import org.usfirst.frc4499.utility.control.Path;
import org.usfirst.frc4499.utility.math.RigidTransform2d;
import org.usfirst.frc4499.utility.math.Rotation2d;
import org.usfirst.frc4499.utility.SoftwarePIDController;
import org.usfirst.frc4499.utility.math.Translation2d;
...
//	        }
	...
	public void setStraightMP(double distanceInches, double maxVelocity, boolean useGyroLock, boolean useAbsolute, double desiredAbsoluteAngle) {
		double yawAngle = useAbsolute ? BHRMathUtils.adjustAccumAngleToDesired(getGyroAngleDeg(), desiredAbsoluteAngle) : getGyroAngleDeg();
		mpStraightController.setPID(mpStraightPIDParams,3);
...
*/
    public synchronized void setControlMode(DriveControlMode controlMode) {
		...
		if (controlMode == DriveControlMode.JOYSTICK) {
			...
			mpStraightController.setPID(mpHoldPIDParams,3);
